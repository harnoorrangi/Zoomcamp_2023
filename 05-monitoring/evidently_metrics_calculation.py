...
@task(name="prepare db", retries=2, retry_delay_seconds=5)
def prep_db():
...
@task(name="prepare metrics", retries=2, retry_delay_seconds=5)
def calculate_metrics_postgresql(curr, i):
    ...
    curr.execute(
        ...
        (begin + datetime.timedelta(i), prediction_drift,
         num_drifted_columns, share_missing_values, fare_quantile)
    )
